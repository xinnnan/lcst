...
var getRepoIssues = function (repo) {
  var apiUrl = 'https://www.loc.gov/photos/?fa=location:oklahoma';
...
var displayIssues = function (photos) {
  ...
  for (var i = 0; i < photos.length; i++) {
    ...
    issueEl.setAttribute('href', photos[i].html_url);
